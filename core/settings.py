...
SECRET_KEY = 'django-insecure-*^y^q^45l3dp7gv#3#y&m7^7kg4)w&l^lt*h5=@7owb8qb+w85'
...
# Define the URL to use when referring to static files (for template use, etc.).
STATIC_URL = '/static/'
...
# Define the URL to use when referring to media files in templates.
MEDIA_URL = '/media/'
